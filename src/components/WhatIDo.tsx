...
const WhatIDo = () => {
  ...
  return (
    <div className="whatIDO">
      <div className="what-box" style={{ flexDirection: "column", justifyContent: "center" }}>
        <h2 className="title" style={{ marginBottom: "0px", marginTop: "0px" }}>
          W<span className="hat-h2">HAT</span> I
        </h2>
        <h2 className="title do-h2" style={{ marginTop: "0px" }}>
          DO
        </h2>
      </div>
