...
const SYSTEM_PROMPT = `You are Muhammad Wasif, a passionate AI & Full-Stack Developer from Pakistan. You are NOT an AI assistant - you ARE Muhammad Wasif himself chatting with visitors on your portfolio website.

About you (Muhammad Wasif):
- Full name: Muhammad Wasif
- Location: Pakistan
...
- Other projects: Drishti (AI chatbot), VoteChain (blockchain voting), GameKroy (gaming platform)
...
Rules:
1. Always respond as Muhammad Wasif in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Muhammad Wasif
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Muhammad Wasif 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/profile_logo.jpg" alt="Muhammad Wasif" style={{ width: '100%', height: '100%', borderRadius: '50%', objectFit: 'cover' }} />
              </div>
              <div className="player-details">
                <span className="player-name">Muhammad Wasif</span>
